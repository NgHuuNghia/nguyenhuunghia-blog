...
if ( ! class_exists( 'News_Make_Bottom_Widget_Layout_One' ) ) :
	/**
	* Bottom News Layout Class One
	*/
	class News_Make_Bottom_Widget_Layout_One extends WP_Widget
	{
		...
		function __construct()
		{
			$opts = array(
				...
				'description'	=> esc_html__( 'Bottom News Layout One. Place it within "FrontPage Bottom Widget Area"', 'news-make' )
			);

			parent::__construct( 'news-make-bottom-news-widget-one', esc_html__( 'NM: Bottom News Layout One', 'news-make' ), $opts );
		}
		...
		function form( $instance ) {
			...
			<p>
	            ...
	            ?>
	            <input id="<?php echo $this->get_field_id( 'cat' ) . $cat; ?>" name="<?php echo $this->get_field_name('cat'); ?>[]" type="checkbox" value="<?php echo $cat; ?>" <?php if(!empty($instance['cat'])) { ?><?php foreach ( $instance['cat'] as $checked ) { checked( $checked, $cat, true ); } ?><?php } ?>><?php if( $cat == 0 ) { echo esc_html__( 'Latest Posts', 'news-make' ); } else { echo get_cat_name($cat); } ?>
	            <br>
	            <?php
	                }
	            ?>
...
if ( ! class_exists( 'News_Make_Bottom_Widget_Layout_Two' ) ) :
	/**
	* Bottom News Layout Class Two
	*/
	class News_Make_Bottom_Widget_Layout_Two extends WP_Widget
	{
		...
		function __construct()
		{
			$opts = array(
				...
				'description'	=> esc_html__( 'Bottom News Layout Two. Place it within "FrontPage Bottom Widget Area"', 'news-make' )
			);

			parent::__construct( 'news-make-bottom-news-widget-two', esc_html__( 'NM: Bottom News Layout Two', 'news-make' ), $opts );
		}
